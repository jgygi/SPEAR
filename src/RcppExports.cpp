...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::mat& >::type post_mu(post_muSEXP);
    Rcpp::traits::input_parameter< arma::mat& >::type post_sigma2(post_sigma2SEXP);
    Rcpp::traits::input_parameter< arma::mat& >::type post_pi(post_piSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(spear_(family, Y, X, Yobs, Xobs, Z, nclasses, functional_path, weights, weights0, weights_case, num_factors, warm_up, max_iter, thres_elbo, thres_count, thres_factor, a0, b0, a1, b1, a2, b2, lower, print_out, interceptsX, interceptsY, post_mu, post_sigma2, post_pi, post_tmuX, post_tsigma2X, post_tpiX, post_tpiX_marginal, post_tmuY, post_tsigma2Y, post_tpiY, tauY, tauZ, log_pi, log_minus_pi, nuXmat, nuYmat, post_a0, post_b0, post_a1, post_b1, post_a2x, post_b2x, post_a2y, post_b2y, meanFactors, seed0, robust_eps, alpha0, L, L2));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_SPEAR_spear_", (DL_FUNC) &_SPEAR_spear_, 57},
    {NULL, NULL, 0}
};
