...
#path <- "~/Documents/Coding/IMPACC/SPEAR/package/"
#path <- "~/Dropbox/shared_folder/SPEAR/"

#Rcpp::sourceCpp(paste0(path, "src/_spear.cpp"))
#source(paste0(path, "R/helpers.R"))
#source(paste0(path, "R/RcppExports.R"))
#source(paste0(path, "R/spear.R"))
#source(paste0(path, "R/SPEARkit.R"))
